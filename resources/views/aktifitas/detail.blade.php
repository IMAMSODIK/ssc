...
<body>
    ...
    <div class="hero-slider" id="home">
        ...
        <!-- Slide 2 -->
        <div class="slide"
            style="background-image: url('{{ asset('landing_assets/images/ctr old/image2.jpeg') }}');">
            <div class="container">
                <div class="slide-content">
        ...
        <!-- Slide 3 -->
        <div class="slide"
            style="background-image: url('{{ asset('landing_assets/images/ctr old/image3.jpeg') }}');">
            <div class="container">
                <div class="slide-content">
    ...
    <section class="about-section" id="about" style="padding: 5rem 0; background-color: #f9f9f9;">
        <div class="container">
            <div class="blog-layout" style="display: flex; flex-wrap: wrap; gap: 3rem;">
                <!-- Main Content Area (Left) -->
                <div class="main-content" style="flex: 2; min-width: 300px;">
                    <article class="blog-post"
                        style="background: white; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); padding: 2.5rem; margin-bottom: 2rem;">
                        <header>
                            <span
                                style="color: var(--secondary); font-weight: 600; letter-spacing: 1px; display: block; margin-bottom: 0.5rem;">AKTIVITAS
                                KAMI</span>
                            <h1
                                style="font-size: 2.2rem; margin: 0.5rem 0 1.5rem; color: var(--primary); line-height: 1.3;">
                                {{ $aktifitas->judul }}
                            </h1>

                            <!-- Meta informasi (tanggal dan kategori) -->
                            <div class="post-meta"
                                style="display: flex; align-items: center; gap: 1.5rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
                                <div style="display: flex; align-items: center; gap: 0.5rem; color: #777;">
                                    <i class="far fa-calendar-alt" style="font-size: 0.9rem;"></i>
                                    <span
                                        style="font-size: 0.9rem;">{{ \Carbon\Carbon::parse($aktifitas->created_at)->translatedFormat('d F Y') }}</span>
                                </div>

                                <div class="post-category">
                                    <span
                                        style="display: inline-block; background-color: #e9f7fe; color: var(--primary); padding: 0.3rem 0.8rem; border-radius: 50px; font-size: 0.8rem; font-weight: 600;">
                                        <i class="fas fa-tag" style="margin-right: 0.3rem; font-size: 0.7rem;"></i>
                                        {{ $aktifitas->kategori }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="post-thumbnail" style="margin-bottom: 2rem;">
                            <img src="{{ asset('storage') . '/' . $aktifitas->thumbnail }}"
                                alt="{{ $aktifitas->judul }}"
                                style="width: 100%; border-radius: 5px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                        </div>

                        <div class="post-content"
                            style="font-family: 'Arial', sans-serif; line-height: 1.8; color: #555;">
                            {!! $aktifitas->deksripsi !!}
                        </div>
                    </article>
                </div>
                ...
                <!-- Sidebar (Right) -->
                <aside class="sidebar" style="flex: 1; min-width: 300px;">
                    <div class="sidebar-widget"
                        style="background: white; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); padding: 1.5rem; margin-bottom: 2rem;">
                        <h3
                            style="color: var(--primary); margin-top: 0; border-bottom: 2px solid #f0f0f0; padding-bottom: 0.5rem;">
                            Artikel Terbaru</h3>
                        <div class="recent-posts">

                            @foreach ($aktifitases as $item)
                                <div class="recent-post"
                                    style="display: flex; gap: 1rem; margin: 1.5rem 0; align-items: center;">
                                    <div class="post-thumb" style="width: 80px; flex-shrink: 0;">
                                        <img src="{{ asset('storage') . '/' . $item->thumbnail }}" alt="Artikel 1"
                                            style="width: 100%; border-radius: 4px;">
                                    </div>
                                    <div class="post-info">
                                        <h4 style="margin: 0 0 0.3rem; font-size: 1rem;"><a href="/aktifitas/detail?judul={{$item->judul}}"
                                                style="color: #333; text-decoration: none;">{{ $item->judul }}</a>
                                        </h4>
                                        <span
                                            style="font-size: 0.8rem; color: #777;">{{ $item->created_at->format('d M Y') }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    {{-- <div class="sidebar-widget" style="background: white; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); padding: 1.5rem; margin-bottom: 2rem;">
                    <h3 style="color: var(--primary); margin-top: 0; border-bottom: 2px solid #f0f0f0; padding-bottom: 0.5rem;">Kategori</h3>
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li style="padding: 0.5rem 0; border-bottom: 1px dashed #eee;"><a href="#" style="color: #555; text-decoration: none;">Hukum Perdata</a></li>
                        <li style="padding: 0.5rem 0; border-bottom: 1px dashed #eee;"><a href="#" style="color: #555; text-decoration: none;">Hukum Pidana</a></li>
                        <li style="padding: 0.5rem 0; border-bottom: 1px dashed #eee;"><a href="#" style="color: #555; text-decoration: none;">Hukum Bisnis</a></li>
                        <li style="padding: 0.5rem 0; border-bottom: 1px dashed #eee;"><a href="#" style="color: #555; text-decoration: none;">Hukum Keluarga</a></li>
                        <li style="padding: 0.5rem 0;"><a href="#" style="color: #555; text-decoration: none;">Hukum Properti</a></li>
                    </ul>
                </div>
                
                <div class="sidebar-widget" style="background: white; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); padding: 1.5rem;">
                    <h3 style="color: var(--primary); margin-top: 0; border-bottom: 2px solid #f0f0f0; padding-bottom: 0.5rem;">Tags</h3>
                    <div class="tags" style="display: flex; flex-wrap: wrap; gap: 0.5rem; margin-top: 1rem;">
                        <a href="#" style="display: inline-block; background: #f0f0f0; color: #555; padding: 0.3rem 0.8rem; border-radius: 20px; font-size: 0.8rem; text-decoration: none;">Litigasi</a>
                        <a href="#" style="display: inline-block; background: #f0f0f0; color: #555; padding: 0.3rem 0.8rem; border-radius: 20px; font-size: 0.8rem; text-decoration: none;">Kontrak</a>
                        <a href="#" style="display: inline-block; background: #f0f0f0; color: #555; padding: 0.3rem 0.8rem; border-radius: 20px; font-size: 0.8rem; text-decoration: none;">Hak Cipta</a>
                        <a href="#" style="display: inline-block; background: #f0f0f0; color: #555; padding: 0.3rem 0.8rem; border-radius: 20px; font-size: 0.8rem; text-decoration: none;">Perdata</a>
                        <a href="#" style="display: inline-block; background: #f0f0f0; color: #555; padding: 0.3rem 0.8rem; border-radius: 20px; font-size: 0.8rem; text-decoration: none;">Korporasi</a>
                    </div>
                </div> --}}
                </aside>
            </div>
