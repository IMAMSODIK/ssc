                    ...
                    <div class="col-sm-12">
                        <div class="card hovercard text-center">
                            ...
                            <div class="user-image">
                                <div class="avatar"><img alt="" src="{{ ($web_profile->logo) ? asset('storage') . '/' . $web_profile->logo : asset('landing_assets/logo/logo.png') }}">
                                </div>
                            </div>
                            <div class="info">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="ttl-info text-start">
                                                    ...
                                                    <span>{{ $web_profile->email ?? '' }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="ttl-info text-start">
                                                    <h6 style="margin-bottom: 10px"><i class="fa fa-location-arrow"></i>Alamat</h6>
                                                    <span>{{ $web_profile->alamat ?? '' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-lg-4 order-sm-0 order-xl-1">
                                        <div class="user-designation">
                                            <div class="title"><a target="_blank"
                                                    href=""><span>{{ $web_profile->nama_perusahaan ?? '' }}</span></a>
                                            </div>
                                            <div class="desc">{{ $web_profile->jargon_perusahaan ?? '' }}</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="ttl-info text-start">
                                                    ...
                                                    <span>
                                                        @if ($web_profile->instagram)
                                                            <a href="{{$web_profile->instagram}}" class="btn btn-success" target="_blank">Instagram</a>
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="ttl-info text-start">
                                                    ...
                                                    <span>{{ $web_profile->whatsapp ?? '' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="follow">
                                    <div class="row">
                                        <div class="col-12 text-md-center border-right">
                                            <div class="follow-num counter">{{ $web_profile->visited ?? '' }}</div>
                                            <span>Kunjungan</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control input-air-primary" id="logo">
...
@section('own_script')
    <script src="{{ asset('own_assets/scripts/profil_web.js') }}"></script>
@endsection
