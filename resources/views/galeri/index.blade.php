            ...
            <div class="page-title">
                <div class="row mt-4">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <button class="btn btn-success" id="tambah-data">Tambah Galeri</button>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        @foreach ($galeris as $galeri)
                                            <tr>
                                                ...
                                                <td style="font-size: 18px" class="text-center">
                                                    <img src="{{asset('storage') . '/' . $galeri->gambar}}" alt="{{$galeri->keterangan}}" width="200px">
                                                </td>
                                                <td style="font-size: 18px">{{ $galeri->keterangan }}</td>
                                                <td class="text-center">
                                                    <ul class="action d-flex justify-content-center">
                                                        <li class="delete" data-id="{{ $galeri->id }}"><a
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myExtraLargeModal">Tambah Galeri</h4>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control input-air-primary" accept="image/*" id="gambar" name="gambar[]" multiple required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" for="keterangan">Keterangan Gambar</label>
                                            <input type="text" class="form-control input-air-primary" id="keterangan"
...
@section('own_script')
    <script src="{{ asset('own_assets/scripts/galeri.js') }}"></script>
@endsection
