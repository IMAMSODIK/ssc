                        ...
                        <div class="card hovercard text-center">
                            ...
                            <div class="user-image">
                                <div class="avatar"><img alt=""
                                        src="{{ asset('dashboard_assets/assets/images/user/7.jpg') }}"></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="media"><img class="img-thumbnail rounded-circle me-3"
                                                src="{{ asset('dashboard_assets/assets/images/user/7.jpg') }}"
                                ...
                                <div class="img-container">
                                    <div class="my-gallery" id="aniimated-thumbnials" itemscope="">
                                        <figure itemprop="associatedMedia" itemscope=""><a
                                                href="{{ asset('dashboard_assets/assets/images/other-images/profile-style-img3.png') }}"
                                                itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded"
                                                    src="{{asset('dashboard_assets/assets/images/other-images/profile-style-img3.png')}}"
                            ...
                            <div class="profile-img-style">
                                ...
                                <div class="row mt-4 pictures my-gallery" id="aniimated-thumbnials-2" itemscope="">
                                    <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                            href="{{ asset('dashboard_assets/assets/images/other-images/profile-style-img3.png') }}"
                                            itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded"
                                                src="{{asset('dashboard_assets/assets/images/other-images/profile-style-img.png')}}"
                                                itemprop="thumbnail" alt="gallery"></a>
                                        <figcaption itemprop="caption description">Image caption 1</figcaption>
                                    </figure>
                                    <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="profile-img-style">
                                ...
                                <hr>
                                <p>Contrary to popular belief, is not simply random text. It has roots in a piece of
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-4">
                                        <div class="my-gallery" id="aniimated-thumbnials-3" itemscope="">
                                            <figure itemprop="associatedMedia" itemscope=""><a
                                                    href="{{ asset('dashboard_assets/assets/images/blog/img.png') }}"
                                                    itemprop="contentUrl" data-size="1600x950"><img
                                                        class="img-fluid rounded" src="{{asset('dashboard_assets/assets/images/blog/img.png')}}"
                                                        itemprop="thumbnail" alt="gallery"></a>
                                                <figcaption itemprop="caption description">Image caption 1</figcaption>
                                            </figure>
                                        </div>
                                    ...
                                    <div class="col-xl-8">
                                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                                            ...
                                            Virginia, looked up one of the more obscure Latin words, consecteturContrary to
                                            popular belief, Lorem Ipsum is not simply random text. It has roots in a piece
